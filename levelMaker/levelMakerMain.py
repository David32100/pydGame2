  ...
  if checkMouse:
    ...
    if screenColor == (0, 0, 2, 255):
      ...
      for key in list(levelLayout.keys()):
        levelLayoutToPrint[str(type(key)).split(".")[1].split("'")[0] + "()" + str(i)] = levelLayout[key]
        i += 1
      ...
      if currentObstacle != None and currentObstacle != "Delete" and currentObstacle != "Text":
        ...
        for obstacle in list(levelLayout.keys()):
          if str(type(obstacle)).split(".")[1].split("'")[0] == "EndGoal":
          ...
          elif str(type(obstacle)).split(".")[1].split("'")[0] == "Text":
