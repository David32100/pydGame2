# To do: client.communications.py Ln 79 Fix message initiated jumping, homeScreen.joinParty.py Ln 45 Finish party screen (right side), None Ln None Make ability for players to talk, homeScreen.settings.py Ln 12 Make settings screen (In General, Player, Account, Controlls: keybinds, account, player color, delete data, delete account, reset settings, volume, uninstall game, credits, report, etc), None Ln None Make accounts and account screen, None Ln None Add SFX and music, None Ln None Add graphics and transitions, None Ln None Polish game, Final step: Setup and share the new game!!!
