...
class OtherJumpers():
  def __init__(self, otherJumperX: float, otherJumperY: float, name:str):
    ...
    self.otherJumperXWithScroll, self.otherJumperY = (otherJumperX, otherJumperY)
    self.otherJumperX = self.otherJumperXWithScroll - globalVariables["scroll"]
  ...
  def updateJumper(self, otherJumperX: float, otherJumperY: float):
    self.otherJumperXWithScroll = otherJumperX
  ...
  def talk(self, text:str):
    ...
    text1Rect.center = (self.otherJumperX + (self.otherJumperWidth / 2), self.otherJumperY - (self.otherJumperHeadRadius * 2) - 28)
